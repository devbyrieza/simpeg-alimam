    ...
    <div className="p-8 max-w-7xl mx-auto space-y-6">
      ...
      <div className="relative mb-8">
        ...
        <input 
          ...
          className="w-full pl-12 pr-4 py-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-gold-500/20 focus:border-gold-500 outline-none transition-all shadow-sm bg-white"
        />
      </div>
